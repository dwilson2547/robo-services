# ESP32 GPS/IMU Baseline Sketch (GTU7 + MPU6050 + UDP)

Existing reference sketch using GTU7 GPS + MPU6050 IMU over WiFi UDP. Use as template for TASK-101 combined sketch with M9N + BNO085 + TJA1051.
